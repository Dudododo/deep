...
//参数设置
#define YOLOV3_VIDEO		"D:\\opencv4.0\\opencv\\sources\\samples\\data\\vtest.avi"		
#define OPENPOSE_VIDEO		"D:\\opencv4.0\\openposeTest.mp4"	
...
int yoloV3()
{
	...
	//coco数据集的名称文件，80类
	string classesFile = "D:\\opencv4.0\\coco.names";
	//yolov3网络模型文件
	String yolov3_model = "D:\\opencv4.0\\yolov3.cfg";
	//权重
	String weights = "D:\\opencv4.0\\yolov3.weights";
...
int openpose()
{
	...
	//读入网络模型和权重文件
	String modelTxt = "D:\\opencv4.0\\openpose_pose_coco.prototxt";
	String modelBin = "D:\\opencv4.0\\caffe_models\\pose\\coco\\pose_iter_440000.caffemodel";
